...
def fixed_padding(inputs, kernel_size, data_format):
  ...
  """
  # seems like somewhat of a hack to get the dimentions right, not very
  # important!
...
def building_block(inputs, filters, is_training, projection_shortcut, strides,
  ...
  # stack of 3x3 filters, each residual block contains 2 such convolutional
  # filters. 
...
def cifar10_resnet_v2_generator(resnet_size, num_classes, data_format=None):
  ...
  """
  # The model starts with a 3*3 convolution and ends with a fully connected
  # layer, with 2*n blocks for feature maps of size 32, 16 and 18. This
  # results in a total of 6*n+2 blocks
  if resnet_size % 6 != 2:
...
def imagenet_resnet_v2_generator(block_fn, layers, num_classes,
  ...
  def model(inputs, is_training):
    ...
    # The input is processed by a 7*7 conv layer with stride 2
    inputs = conv2d_fixed_padding(
    ...
    # All resnets consist of 4 resBlock layers : 64, 128, 256 and 512 which correspond
    # to the no. of layers per conv filter. The number of resBlocks is
    # configurable in each of these.
    inputs = block_layer(
